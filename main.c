  ...
  for ( i = 0; i < strlen(string); i++)                             //the conditions for the encryption to work
    {
       ...
       if (string[i]<65 || string[i]>122)                           //code checks if the ASCII value of the letter lies outside upper case A to lower case z
 {
   
     message[i]= ' ';                                               //if the above statement is true, the console will print a space
